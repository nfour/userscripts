...
// @updateURL   https://github.com/nfour/userscripts/master/tree/build/youtubeHighlights.user.js
...
/*! export toVNode [provided] [maybe used (runtime-defined)] [usage prevents renaming] */
/*! other exports [not provided] [maybe used (runtime-defined)] */
...
/*! export __esModule [provided] [maybe used (runtime-defined)] [usage prevents renaming] */
/*! export default [provided] [maybe used (runtime-defined)] [usage prevents renaming] */
/*! export vnode [provided] [maybe used (runtime-defined)] [usage prevents renaming] */
/*! other exports [not provided] [maybe used (runtime-defined)] */
/*! runtime requirements: __webpack_exports__ */
/***/ ((__unused_webpack_module, exports) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const cash_dom_1 = __webpack_require__(/*! cash-dom */ "./node_modules/cash-dom/dist/cash.js");
const mobx_1 = __webpack_require__(/*! mobx */ "./node_modules/mobx/lib/mobx.module.js");
const tovnode_1 = __webpack_require__(/*! snabbdom/tovnode */ "./node_modules/snabbdom/tovnode.js");
...
class VideoThumbnail {
    ...
    init() {
        ...
        this.hasInit = true;
        console.log({ vnode: tovnode_1.default(this.$self.get()[0]) });
        const toggleHighlighted = mobx_1.action(() => {
            console.log('clicked', this.id);
            this.state.isHighlighted = !this.state.isHighlighted;
        });
        this.$highlightBtn = cash_dom_1.default(`<div></div>`)
...
void (async () => {
    console.log('/|{z1111111111111111 starting...');
    cash_dom_1.default(() => {
